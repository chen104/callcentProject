...
public class MachinStatueRunable1 implements Runnable {
    String data;
    private List<com.example.vmac.callCenter.Message> list;
    private Handler handler;
    private Map<String,Object> conversationContext;

    public MachinStatueRunable1(String data, List<com.example.vmac.callCenter.Message> list, Map<String,Object> conversationContext, Handler handler){
        this.data=data;
        this.list=list;
    ...
    public void  searchMachinStatue(){
        ...
        try {
            ...
            if(result!=null&&result.length()>0){
                ...
                if(state){
                    Boolean isGuarantee=resultJson.get(RcmsConstant.isGuarantee).getAsBoolean();
